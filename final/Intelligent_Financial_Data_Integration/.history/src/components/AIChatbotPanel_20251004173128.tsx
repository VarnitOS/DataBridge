  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: "Hello! I'm your EY DataFusion AI assistant. I can help you understand schema mappings, resolve conflicts, and suggest data normalization strategies. What would you like to know?",
      timestamp: new Date(),
    }
  ]);
