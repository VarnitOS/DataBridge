...
export interface BentoProps {
  ...
  /** kept for compatibility, but ignored (tilt is disabled globally) */
  enableTilt?: boolean;
  glowColor?: string;
  clickEffect?: boolean;
...
}> = ({ children, className = '', style, refCallback }) => (
  <div className={`card ${className}`} style={style} ref={refCallback || undefined}>
    {children}
  </div>
);
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cardData.map((card, index) => {
          ...
          const cardProps = {
            ...
            style: { backgroundColor: card.color, '--glow-color': glowColor } as React.CSSProperties
          };
