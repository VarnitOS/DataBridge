// src/components/magic/MagicBento.tsx
...
export interface BentoProps {
  ...
  /** Kept for backward compatibility with existing usages, but ignored. */
...
/* ------------------------------------------------------------------ */
/* ParticleCard (no magnetism; optional tilt only)                     */
/* ------------------------------------------------------------------ */
export const ParticleCard: React.FC<{
  ...
  /** Ignored, kept for compatibility so existing props won’t break */
  enableMagnetism?: boolean;
}> = ({
  children,
  className = '',
...
/* ------------------------------------------------------------------ */
/* Global spotlight overlay (unchanged)                                */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/* MagicBento (magnetism removed globally)                             */
/* ------------------------------------------------------------------ */
const MagicBento: React.FC<BentoProps> = ({
  ...
  /** Provided but ignored to avoid breaking callers */
  enableMagnetism, // eslint-disable-line @typescript-eslint/no-unused-vars
}) => {
    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cardData.map((card, index) => {
          ...
          if (enableStars) {
            return (
              <ParticleCard
                ...
                /* enableMagnetism intentionally ignored */
              >
          ...
          // Non-particle fallback; still no magnetism
          return (
            <div
              key={index}
              {...cardProps}
