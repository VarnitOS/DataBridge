                  ...
                  <ParticleCard className="card card--border-glow" glowColor="132, 0, 255" particleCount={8} enableTilt>
                    <Card className="p-6">
                      <div className="text-center space-y-4">
                        <h2 className="text-2xl font-bold">Custom Tab: {currentView}</h2>
                        <p className="text-muted-foreground">
                          This is your custom tab. You can customize this content as needed.
                        </p>
                        <div className="bg-muted/30 rounded-lg p-4">
                          <p className="text-sm">
                            Tab ID: <code className="bg-muted px-2 py-1 rounded">{currentView}</code>
                          </p>
                        </div>
                      </div>
                    </Card>
